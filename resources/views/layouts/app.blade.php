            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav">
                        &nbsp;
                        <li><a href="{{ route('transactionRoute') }}">Add Transaction</a></li>
                        <li><a href="{{ route('subtransactionsRoute') }}">Subtransactions</a></li>                         
                        <li><a href="{{ route('adminCategoriesRoute') }}">Categories</a></li>
                    </ul>
